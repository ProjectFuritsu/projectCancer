...
class Page2PersonalInformationScreen extends StatefulWidget {
  ...
  @override
  State<Page2PersonalInformationScreen> createState() => _Page2PersonalInformationScreenState();
}

class _Page2PersonalInformationScreenState extends State<Page2PersonalInformationScreen> {
  String? gender;
  ...
  Widget _buildFormFields() {
    return Column(
      ...
      children: [
        Row(
          children: [
            Expanded(flex: 2, child: CustomTextField(hintText: "First Name")),
            const SizedBox(width: 16),
            Expanded(flex: 1, child: CustomTextField(hintText: "Suffix")),
          ],
        ),
        ...
        CustomModalDatePickerField(
          ...
          onDateSelected: (date) => setState(() => selectedDOB = date),
        ),
        const SizedBox(height: 16),
        CustomModalDropdownField<String>(
          ...
          validator: (val) => val == null ? 'Please select a marital status' : null,
        ),
        const SizedBox(height: 16),
        CustomTextField(
          ...
          validator: (val) {
            ...
            if (!phoneRegex.hasMatch(val)) return 'Please enter a valid phone number';
            return null;
          },
        ),
        const SizedBox(height: 16),
        CustomTextField(
          hintText: "Occupation",
          validator: (val) {
            if (val == null || val.isEmpty) return 'Please enter your occupation';
            return null;
          },
        ),
      ],
